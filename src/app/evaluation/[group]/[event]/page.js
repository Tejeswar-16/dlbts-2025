...
export default function Judging({eventSent}){
            ...
            <div className="relative bg-gray-100 py-5 min-h-screen lg:bg-gray-100">
                ...
                <div className="mx-auto bg-white rounded-xl shadow-xl mt-5 w-250">
                        ...
                        <table className="mx-auto text-center w-200 pb-2">
                            ...
                            <tbody>
                                <tr>
                                    <td className="font-sans px-2 py-2 font-semibold border border-black">Logeswar</td>
                                    <td className="font-sans px-2 py-2 font-semibold border border-black"><button className="bg-yellow-200 p-2 rounded-xl shadow-xl hover:cursor-pointer">Award Marks</button></td>
                                </tr>
                            </tbody>
                        </table>
                </div>
